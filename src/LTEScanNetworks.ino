...
#define APP_LTE_USER_NAME "your-truphone-email-address" // replace with your username
#define APP_LTE_PASSWORD  "your-truphone-password" // replace with your password
